...
def course_structure(mcp: McpClient) -> dict[str, Any]:
    ...
    course_resp = mcp.call_tool("course.create", {
        "title": course_title,
    ...
    module_a = mcp.call_tool("module.create", {
        "courseId": course["id"],
        "title": "Module A — Greetings",
        "description": "How to greet strangers.",
    })
    module_b = mcp.call_tool("module.create", {
        "courseId": course["id"],
        "title": "Module B — Farewells",
        "description": "How to say goodbye.",
    })

    lesson_a = mcp.call_tool("lesson.create", {
        "moduleId": module_a["module"]["id"],
        "title": "Lesson A1 — Hello",
        "description": "Saying hello at different times of day.",
    })
    lesson_b = mcp.call_tool("lesson.create", {
        "moduleId": module_b["module"]["id"],
        "title": "Lesson B1 — Goodbye",
        "description": "Saying goodbye.",
    })

    step_a1 = mcp.call_tool("flowStep.create", {
        "lessonId": lesson_a["lesson"]["id"],
        "title": "Morning",
        "content": "Buenos días means good morning.",
        "step_type": "message",
        "is_starting_step": True,
    })
    step_a2 = mcp.call_tool("flowStep.create", {
        "lessonId": lesson_a["lesson"]["id"],
        "title": "Afternoon",
        "content": "Buenas tardes means good afternoon.",
        "step_type": "message",
    })
    step_a3 = mcp.call_tool("flowStep.create", {
        "lessonId": lesson_a["lesson"]["id"],
        "title": "Quick check",
    ...
    step_b1 = mcp.call_tool("flowStep.create", {
        "lessonId": lesson_b["lesson"]["id"],
        "title": "Goodbye",
        "content": "Adiós means goodbye.",
        "step_type": "message",
        "is_starting_step": True,
    })
    step_b2 = mcp.call_tool("flowStep.create", {
        "lessonId": lesson_b["lesson"]["id"],
        "title": "See you later",
    ...
    mcp.call_tool("connection.add", {
        "flowStepId": step_a1["flow_step"]["id"],
        "to_step_id": step_a2["flow_step"]["id"],
        "button_text": "Next",
        "button_action": "next",
        "button_order": 1,
    })
    mcp.call_tool("connection.add", {
        "flowStepId": step_a2["flow_step"]["id"],
        "to_step_id": step_a3["flow_step"]["id"],
        "button_text": "Next",
        "button_action": "next",
        "button_order": 1,
    })
    mcp.call_tool("connection.add", {
        "flowStepId": step_b1["flow_step"]["id"],
        "to_step_id": step_b2["flow_step"]["id"],
        "button_text": "Next",
        "button_action": "next",
        "button_order": 1,
    })

    print(f"[setup] Course tree created.")

    return {
        "title": course_title,
        "course": course,
        "modules": [module_a["module"], module_b["module"]],
        "lessons": [lesson_a["lesson"], lesson_b["lesson"]],
        "steps_a": [step_a1["flow_step"], step_a2["flow_step"], step_a3["flow_step"]],
        "steps_b": [step_b1["flow_step"], step_b2["flow_step"]],
    }
